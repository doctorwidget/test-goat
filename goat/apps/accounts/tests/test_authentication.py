...
@patch('goat.apps.accounts.authentication.requests.post')
class AuthenticateTest(TestCase):
    ...
    def test_find_existing_user_with_email(self, mock_post):
        mock_post.return_value.json.return_value = {
            'status': 'okay',
            'email': 'a@b.com'
        }
    ...
    def test_logs_non_okay_responses_from_persona(self, mock_post):
        ...
        logger = logging.getLogger('goat.apps.accounts.authentication')
